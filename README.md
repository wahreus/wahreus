...
| :---------------------------------------------------------------------: | ----------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| [FareWise](https://github.com/wahreus/farewise)                         | Serverless TfL fare optimization app with Terraform IaC and automated CI/CD   | Python, FastAPI, AWS Lambda, API Gateway, Terraform, GitHub Actions |
